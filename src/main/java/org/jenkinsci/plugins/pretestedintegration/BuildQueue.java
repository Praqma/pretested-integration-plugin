...
public final class BuildQueue {
    ...
    /**
     * Block until the commit can be tested without any other commits running at
     * the same time. After calling this function, release() MUST be called, so
     * make sure that every error scenario releases the lock at some point.
     */
