...
public class JENKINS_25546_IT {
    ...
    public void ambiguityInMultiSCMRemote() throws Exception {
        ...
        UniqueBranchGenerator generator = new UniqueBranchGenerator(repo1, "One","Two","Three").usingBranch("ready/scenario1").build();
     ...
     *  - Create a ready/scenario2 branch on the stble repository.
     * 
     * Results
    ...
    public void ambituigyInMultiSCMRemoteNotIntegrationTargetSuccess() throws Exception {
        ...
        UniqueBranchGenerator generator = new UniqueBranchGenerator(repo1, "One","Two","Three").usingBranch("ready/scenario2").build();
    ...
    public void ambiguityMultiSCMIntegrationTarget() throws Exception {
        ...
        UniqueBranchGenerator branch = new UniqueBranchGenerator(repo1, "Message1","Message2").usingBranch("ready/scenario3").build();
    ...
    public void matchingRemoteIntegrationTargetSuccess() throws Exception {
        ...
        UniqueBranchGenerator branch = new UniqueBranchGenerator(repo1, "One1","Two2","Three3").usingBranch("ready/scenario4").build();
