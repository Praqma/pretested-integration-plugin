...
public class AccumulatedCommitMessageIT {
    ...
    public void mergeCommitContainsOnlyMessagesFromCorrectBranch() throws Exception {
        ...
        commitCommand.setMessage(String.format("4. time updating info file on branch %s%n%s", FEATURE_BRANCH_NAME, multiLineCommitMessage));
        commitCommand.setAuthor(AUTHOR_NAME, AUTHOR_EMAIL);
        // make the commit
        revCommit = commitCommand.call();
    ...
    public void commitMessageShouldOnlyCollectFromOwnBranch() throws Exception {
        ...
        commitCommand = gitrepo.commit();
        multiLineCommitMessage = String.format("%n%n- major refactoring of tests%n- boring adding new lines");
        commitCommand.setMessage(String.format("Commit no. 5 in time, branch %s%n%s", FEATURE_BRANCH_NAME2, multiLineCommitMessage));
        commitCommand.setAuthor(AUTHOR_NAME, AUTHOR_EMAIL);
        // make the commit
        revCommit = commitCommand.call();
    ...
    public void commitMessageShouldOnlyCollectFromConnectedBranches() throws Exception {
        ...
        commitCommand = gitrepo.commit();
        multiLineCommitMessage = String.format("%n%n- major refactoring of tests%n- boring adding new lines");
        commitCommand.setMessage(String.format("Commit no. 4 in time, branch %s%n%s", FEATURE_BRANCH_NAME2, multiLineCommitMessage));
        commitCommand.setAuthor(AUTHOR_NAME, AUTHOR_EMAIL);
        // make the commit
        revCommit = commitCommand.call();
