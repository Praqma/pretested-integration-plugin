...
public class GitUtilsTest {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void ShouldThrowExceptionWhenRemovingRemoteIfProvidedRepositoryIsNull() {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void ShouldThrowExceptionWhenRemovingRemoteIfProvidedBranchNameIsNull() {
